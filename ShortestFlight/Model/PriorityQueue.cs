...
{
    public class PriorityQueue<T> where T : Path
    {
        ...
        private int _bin_locate_pos(double distance, bool is_incremental)
        {
            int mid = 0;
            int low = 0;
        ...
        {
            element_distance_pair_list.Insert(_bin_locate_pos(element.get_distance(), is_incremental), element);
